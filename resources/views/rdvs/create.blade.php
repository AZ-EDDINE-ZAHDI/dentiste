            ...
            <div class="w-full overflow-x-auto">
                ...
                <div class=" justify-center w-full"><br>
                    ...
                    <label class="block text-sm font-semibold">
                        ...
                        <input required name="nom" type="text" placeholder="Nom et prénom" class="block w-full mt-1 mb-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                    <label class="block text-sm font-semibold">
                        <span class="text-gray-700 dark:text-gray-400">Télephone</span>
                        <input required name="numero" type="text" placeholder="Télephone" class="block w-full mt-1 mb-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
                    <label class="block text-sm font-semibold">
                    ...
                    <label class="block text-sm font-semibold">
                        ...
                        <input required name="prix" type="text" placeholder="Prix" class="block w-full mt-1 mb-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-teal-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                    </label>
